...
public class MapGenPath : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < numberOfPieces; i++) {
            ...
            mob.compose(new Mobius((Random.value * 2 - 1) * Mathf.PI * angularRange));
			//mob = new Mobius((Random.value * 2 - 1) * Mathf.PI * angularRange);
			//mob.compose(new Mobius(0, distancePerPiece, true));
        }
    }
